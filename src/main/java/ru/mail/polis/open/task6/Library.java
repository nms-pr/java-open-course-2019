...
public final class Library {
    ...
    static void work() {
        if (counter == 0) {
            ...
            books.add(new Book(1, 1, "Преступление и наказание", "Классика"));
            books.add(new Book(1, 2, "Капитанская дочка", "Классика"));
            ...
            books.add(new Book(2, 3, "Виноваты звёзды", "Мировые бестселлеры"));
